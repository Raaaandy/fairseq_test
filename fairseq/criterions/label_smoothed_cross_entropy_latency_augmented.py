...
class LatencyAugmentedLabelSmoothedCrossEntropyCriterion(
    ...
    def forward(self, model, sample, reduce=True):
        ...
        #print("Debug: net_output", net_output)
    ...
    def compute_latency_loss(self, model, sample, net_output):
        ...
        print("dec out greater than 0",net_output[0].ge(0).all())
        ...
        # print("model:", model, "at /gscratch/intelligentsystems/randy/fairseq/fairseq/criterions/label_smoothed_cross_entropy_latency_augmented.py")
        target_padding_mask = (
        ...
        print("sample net input src lengths", sample["net_input"]["src_lengths"], sample["net_input"]["src_lengths"].size())
        src_lengths = (
        ...
        # print("Debug: latency type", self.latency_avg_type, "at /gscratch/intelligentsystems/randy/fairseq/fairseq/criterions/label_smoothed_cross_entropy_latency_augmented.py")
        # raise KeyboardInterrupt()
        ...
        print("latency gather method", self.latency_gather_method)
