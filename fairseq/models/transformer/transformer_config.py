...
class TransformerConfig(FairseqDataclass):
    ...
    def __getattr__(self, name):
        # print("Debug:", name, _NAME_PARSER, re.match(_NAME_PARSER, name), "at /gscratch/intelligentsystems/randy/fairseq/fairseq/models/transformer/transformer_config.py")
