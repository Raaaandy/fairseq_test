...
class TransformerMonotonicDecoder(TransformerDecoder):
    ...
    def __init__(self, args, dictionary, embed_tokens, no_encoder_attn=False):
        import os
        print("args:",args)
        print("simul_type:",args.simul_type)

        if(args.simul_type is not None):
            print("Simul type is not None")
            print("Simul type: ", args.simul_type, os.getcwd())
        ...
        #print("Debug: dictionary", len(dictionary)," at /gscratch/intelligentsystems/randy/fairseq/examples/simultaneous_translation/models/transformer_monotonic_attention.py")
        #for i in range(0, len(dictionary)):
        #    print(i, dictionary[i])
        # raise Exception("Debug: dictionary")
        self.dictionary = dictionary
        self.layers = nn.ModuleList([])
        self.layers.extend(
            [
